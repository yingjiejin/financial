CREATE TABLE `product` (
  ...
  `reward_rate` decimal(5,3) NOT NULL COMMENT '收益率，0-100百分比值',
  `status` varchar(20) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '状态，AUDINTING：审核中，IN_SELL：销售中，LOCKED：暂停销售，FINISHED：已结束',
